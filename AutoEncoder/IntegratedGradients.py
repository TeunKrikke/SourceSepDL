        ...
        if isinstance(sample, list):
            ...
            for i in range(len(sample)):
                if reference is None:
                    _output = integrated_gradients.linearly_interpolate(sample[i], None, num_steps)
                else:
                    _output = integrated_gradients.linearly_interpolate(sample[i], reference, num_steps)
